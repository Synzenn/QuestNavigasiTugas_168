                        ...
                        Column(Modifier.padding(horizontal = 14.dp, vertical = 12.dp)) {
                            Row(
                                ...
                                Column(Modifier.weight(1f)) {
                                    ...
                                    Text(text = "Yuzuhira", fontSize = 17.sp)
                                ...
                                Column(Modifier.weight(1f)) {
                                    ...
                                    Text(text = "Jln. Jnda Kembang No. 1", fontSize = 17.sp)
                                }
                            }
                        }
                    }
                        ...
                        Column(Modifier.padding(horizontal = 14.dp, vertical = 12.dp)) {
                            Row(
                                ...
                                Column(Modifier.weight(1f)) {
                                    ...
                                    Text(text = "Kinanti", fontSize = 17.sp)
                                    Spacer(Modifier.height(8.dp))
                                    Text(
                                        "STATUS PERKAWINAN",
                                        fontSize = 14.sp,
                                    ...
                                    Text(text = "Single", fontSize = 17.sp)
                                }
                                Column(Modifier.weight(1f)) {
                                    Text(
                                        "JENIS KELAMIN",
                                    ...
                                    Text(text = "Jln. Tamansiswa", fontSize = 17.sp)
                                }
                            }
                        }
                    }
